...
public class Opening extends Activity implements OnClickListener {
    ...
    //Test Mode Buttons
    private static Button bE_Block;
    private static Button bV400_ON, bV500_ON, bV700_ON, bV1000_ON, bV400_OFF, bV500_OFF, bV700_OFF, bV1000_OFF;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bV400_ON = findViewById(R.id.bV400_ON);
        bV400_OFF = findViewById(R.id.bV400_OFF);
        bV500_ON = findViewById(R.id.bV500_ON);
        bV500_OFF = findViewById(R.id.bV500_OFF);
        bV700_ON = findViewById(R.id.bV700_ON);
        bV700_OFF = findViewById(R.id.bV700_OFF);
        bV1000_ON = findViewById(R.id.bV1000_ON);
        bV1000_OFF = findViewById(R.id.bV1000_OFF);

        bV400_ON.setOnClickListener(this);
        bV400_OFF.setOnClickListener(this);
        bV500_ON.setOnClickListener(this);
        bV500_OFF.setOnClickListener(this);
        bV700_ON.setOnClickListener(this);
        bV700_OFF.setOnClickListener(this);
        bV1000_ON.setOnClickListener(this);
        bV1000_OFF.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.bV400_ON:
                //mainL.setBackgroundResource(R.drawable.irak_vaziyet);
                try {
                    RESTService.flatBuildingStatus("V400", "on");
                } catch (ExecutionException e) {
                    e.printStackTrace();
                } catch (InterruptedException e) {
                    e.printStackTrace();
            ...
            case R.id.bV400_OFF:
                //mainL.setBackgroundResource(R.drawable.irak_vaziyet);
                try {
                    RESTService.flatBuildingStatus("V400", "off");
                } catch (ExecutionException e) {
                    e.printStackTrace();
                } catch (InterruptedException e) {
                    e.printStackTrace();
            ...
            case R.id.bV500_ON:
                //mainL.setBackgroundResource(R.drawable.irak_vaziyet);
                try {
                    RESTService.flatBuildingStatus("V500", "on");
                } catch (ExecutionException e) {
                    e.printStackTrace();
                } catch (InterruptedException e) {
                    e.printStackTrace();
            ...
            case R.id.bV500_OFF:
                //mainL.setBackgroundResource(R.drawable.irak_vaziyet);
                try {
                    RESTService.flatBuildingStatus("V500", "off");
                } catch (ExecutionException e) {
                    e.printStackTrace();
                } catch (InterruptedException e) {
                    e.printStackTrace();
            ...
            case R.id.bV700_ON:
                //mainL.setBackgroundResource(R.drawable.irak_vaziyet);
                try {
                    RESTService.flatBuildingStatus("V700", "on");
                } catch (ExecutionException e) {
                    e.printStackTrace();
                } catch (InterruptedException e) {
                    e.printStackTrace();
            ...
            case R.id.bV700_OFF:
                //mainL.setBackgroundResource(R.drawable.irak_vaziyet);
                try {
                    RESTService.flatBuildingStatus("V700", "off");
                } catch (ExecutionException e) {
                    e.printStackTrace();
                } catch (InterruptedException e) {
                    e.printStackTrace();
            ...
            case R.id.bV1000_ON:
                //mainL.setBackgroundResource(R.drawable.irak_vaziyet);
                try {
                    RESTService.flatBuildingStatus("V1000", "on");
                } catch (ExecutionException e) {
                    e.printStackTrace();
                } catch (InterruptedException e) {
                    e.printStackTrace();
            ...
            case R.id.bV1000_OFF:
                //mainL.setBackgroundResource(R.drawable.irak_vaziyet);
                try {
                    RESTService.flatBuildingStatus("V1000", "off");
                } catch (ExecutionException e) {
                    e.printStackTrace();
                } catch (InterruptedException e) {
                    e.printStackTrace();
